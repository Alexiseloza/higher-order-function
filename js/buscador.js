...
//Тази малка демонстрация е създадена, за да допълни предишната.    Затова се използва само Javascript, без рамки
...
marca.addEventListener('input', e => {
    ...
    // Send call the function of filtering Cars
    filtrarAuto();
});
...
year.addEventListener('input', e => {
    ...
    // Изпрати повикване функцията за филтриране на автомобили
    filtrarAuto();
});
...
function noResultado() {
    ...
    noResultado.appendChild(document.createTextNode('тук няма  Results'));
